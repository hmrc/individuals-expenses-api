...
@Singleton
class RetrieveOtherExpensesRequestValidator @Inject() (appConfig: AppConfig)(implicit
    currentDateTime: CurrentDateTime,
    currentTaxYear: CurrentTaxYear)
    extends RequestValidator[RetrieveOtherExpensesRawData, RetrieveOtherExpensesRequest] {
  ...
  override protected def validationSet: List[RetrieveOtherExpensesRawData => List[List[MtdError]]] =

...
@Singleton
class CreateAmendOtherExpensesRequestValidator @Inject() (appConfig: AppConfig)(implicit
    currentDateTime: CurrentDateTime,
    currentTaxYear: CurrentTaxYear)
    extends RequestValidator[CreateAndAmendOtherExpensesRawData, CreateAndAmendOtherExpensesRequest] {
  ...
  override protected def validationSet: List[CreateAndAmendOtherExpensesRawData => List[List[MtdError]]] =
    List(parameterFormatValidation, bodyFormatValidation, parameterRuleValidation, bodyFieldValidation)

...
class RetrieveOtherExpensesValidator extends Validator[RetrieveOtherExpensesRawData] {
  ...
  private def parameterRuleValidation: RetrieveOtherExpensesRawData => List[List[MtdError]] = { _ =>
    List(

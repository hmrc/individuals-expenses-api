...
class RetrieveOtherExpensesValidatorFactorySpec extends UnitSpec {
  ...
  private val validatorFactory = new RetrieveOtherExpensesValidatorFactory
    ...
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(
          RetrieveOtherExpensesRequestData(parsedNino, parsedTaxYear)
        )
      }
    }

...
trait MockIgnoreEmploymentExpensesService extends MockFactory {

  val mockService: IgnoreEmploymentExpensesService = mock[IgnoreEmploymentExpensesService]
  ...
  object MockIgnoreEmploymentExpensesService {
    ...
    def ignore(requestData: IgnoreEmploymentExpensesRequest): CallHandler[Future[Either[ErrorWrapper, ResponseWrapper[Unit]]]] = {
      (mockService
        .ignore(_: IgnoreEmploymentExpensesRequest)(_: HeaderCarrier, _: ExecutionContext, _: EndpointLogContext))
        .expects(requestData, *, *, *)
    }
  }
}

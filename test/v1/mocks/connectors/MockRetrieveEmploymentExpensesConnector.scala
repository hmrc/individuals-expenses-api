...
trait MockRetrieveEmploymentExpensesConnector extends MockFactory {
  ...
  object MockRetrieveEmploymentExpensesConnector {
    ...
    def retrieveEmploymentExpenses(requestData: RetrieveEmploymentExpensesRequest): CallHandler[Future[RetrieveEmploymentExpensesBody]] = {
      (mockRetrieveEmploymentExpensesConnector
        .retrieveEmploymentExpenses(_: RetrieveEmploymentExpensesRequest)(_: HeaderCarrier, _: ExecutionContext)
          .expects(requestData, *, *)
    }
  }
}

...
import v1r7a.mocks.validators.MockDeleteEmploymentExpensesValidator
...
class DeleteEmploymentExpensesRequestParserSpec extends UnitSpec {
  ...
  trait Test extends MockDeleteEmploymentExpensesValidator {
    lazy val parser = new DeleteEmploymentExpensesRequestParser(mockValidator)
  }

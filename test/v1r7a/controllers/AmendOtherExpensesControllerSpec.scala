...
import v1r7a.mocks.requestParsers.MockAmendOtherExpensesRequestParser
import v1r7a.mocks.services.{MockAmendOtherExpensesService, MockAuditService, MockEnrolmentsAuthService, MockMtdIdLookupService}
import v1r7a.models.audit.{AuditError, AuditEvent, AuditResponse, ExpensesAuditDetail}
import v1r7a.models.errors._
import v1r7a.models.hateoas.{HateoasWrapper, Link}
import v1r7a.models.hateoas.Method.{DELETE, GET, PUT}
import v1r7a.models.outcomes.ResponseWrapper
import v1r7a.models.request.amendOtherExpenses.{AmendOtherExpensesBody, AmendOtherExpensesRawData, AmendOtherExpensesRequest, PatentRoyaltiesPayments, PaymentsToTradeUnionsForDeathBenefits}
import v1r7a.models.response.amendOtherExpenses.AmendOtherExpensesHateoasData
